...
<div class="col-12 grid-margin">
  <div class="card">
    ...
    <form class="form-sample" method="POST" action="{{ route('dataanalisa.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3">
            ...
            aria-describedby="emailHelp" name="namawisata" placeholder="nama wisata" >
            @error('namawisata')
        ...
        <div class="mt-3 mb-3">
            ...
            <textarea name="deskripsi" id="editor" cols="30" rows="10" class="replies-field">{{ old('isi') }}</textarea>
            @error('deskripsi')
                <div class="invalid-feedback">
